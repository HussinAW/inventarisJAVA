...
public Elektronik(int StandarJumlah, boolean Analisis_jumlah, int Standar_baik,boolean Analisis_Kondisi,
    String StandarPosisi, String StandarPosisi2, boolean AnalisisPosisi){
